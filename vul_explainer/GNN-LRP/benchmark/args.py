...
class GeneralArgs(Tap):
    ...
    model_name: str = 'RevealModel'  # specify model name
...
class TrainArgs(GeneralArgs):
    ...
    epoch: int = 50                        # Epochs to stop training
    ...
    def process_args(self) -> None:
        ...
        if self.ckpt_dir == None:
            ...
            #                              str(self.target_idx))
            self.ckpt_dir = '/home/GNNLRP_model/model_com/deepwukong/gnn_53.32_78.15_63.21.ckpt'
...
class DataArgs(GeneralArgs):
    ...
    dim_hidden: int = 200                   # node hidden feature's dimension
