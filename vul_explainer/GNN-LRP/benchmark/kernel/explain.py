...
def sample_explain(explainer, data, x_collector: XCollector, **kwargs):
    ...
    #     if x_args.save_fig:
    #         print('save fig as:', os.path.join('/home/DIG-main/dig/xgraph/GNN-LRP/figures', 'visual_results', f'{explainer.__class__.__name__}.png'))
    #         g_name=data.name[0].split('.json')[0]
    #         #plt.savefig(os.path.join(ROOT_DIR, 'visual_results', f'{explainer.__class__.__name__}.png'), dpi=300)
    #         plt.savefig(os.path.join('/home/DIG-main/dig/xgraph/GNN-LRP/gcn_results', f'{g_name}.png'), dpi=300)
    #     else:
    #         plt.show()
