...
def sample_explain(explainer, data, x_collector: XCollector, **kwargs):
    ...
    #     if x_args.save_fig:
    #         print('save fig as:', os.path.join('/home/DIG-main/dig/xgraph/GradCAM/figures', 'visual_results', f'{explainer.__class__.__name__}.png'))
    ...
    #         plt.savefig(os.path.join('/home/DIG-main/dig/xgraph/GradCAM/figures', f'{g_name}.png'), dpi=300)
    #     else:
    #         plt.show()
