...
import os,sys
sys.path.append("/home/DIG-main/dig/xgraph/GNNExplainer-master")
from definitions import ROOT_DIR
ROOT_DIR = '/home/DIG-main/dig/xgraph/GNNExplainer-master'
import torch
import time
...
if args['common'].task == 'test':
    ...
    ex_target_idx = 0 if args['common'].target_idx != -1 else args['common'].explain_idx #graph classification 0
